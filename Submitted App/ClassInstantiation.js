...
const algebra1 = new Class(
    ...
    "Year",
    "none",
    "Covers basic algebraic concepts including functions and polynomials.",
    "B",
    [3.0, 2, 1.8],
    ["Challenging but worth it.", "Helped me understand math better."],
    4,
...
const algebra3 = new Class(
    ...
    "Year",
    "none",
    "Covers difficult algebraic concepts including chain rule and trinomials.",
    "B",
    [5.0, 2, 3.8],
    ["Challenging but worth it.", "Helped me understand math better."],
    4,
